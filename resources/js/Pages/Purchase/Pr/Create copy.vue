<template>
    <Main>
      ...
      <div class="panel panel-inverse">
        <div class="panel-heading">
          <h4 class="panel-title">Purchase Request</h4>
        ...
        <div class="panel-body">
          <!-- Notification -->
          <div v-if="notification" class="alert" :class="notification.type" role="alert">
          ...
          <form @submit.prevent="submitForm">
            ...
            <!-- Submit Button -->
            <div class="text-end">
              <button type="submit" class="btn btn-secondary mb-4 btn-sm mr-2">Submit Request</button>
  ...
  const notification = ref(null);
    ...
    const submitForm = () => {
    Inertia.post('/purchase-request', form.value, {
        onSuccess: (page) => {
        notification.value = {
            message: page.props.flash.success || 'Purchase Request submitted successfully.',
            type: 'alert-success',
        };

        // Redirect to index page with success message
        Inertia.visit('/purchase-requests', {
            method: 'get',
            preserveState: true,
            flash: {
            success: notification.value.message,
            },
        });
        },
        onError: (errors) => {
        notification.value = {
            message: 'There was an error submitting the Purchase Request.',
            type: 'alert-danger',
        };
        }
    });
