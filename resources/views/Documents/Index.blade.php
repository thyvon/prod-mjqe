...
<body class="docs-page">    
        ...
        <div class="branding docs-branding">
            <div class="container-fluid position-relative py-2">
                <div class="docs-logo-wrapper">
	                ...
	                <div class="site-logo"><a class="navbar-brand" href="index.html"><img class="logo-icon me-2" src="{{ asset('documentation/images/coderdocs-logo.svg') }}" alt="logo"><span class="logo-text text-white">E-Purchasing <span class="text-alt">Docs</span></span></a></div>    
    ...
    <div class="docs-wrapper">
        @include('Documents.navigation')
	    <div class="docs-content">
		    <div class="container">
			    <article class="docs-article" id="section-1">
				    <header class="docs-header">
					    <h1 class="docs-heading">Introduction <span class="docs-time">Last updated: 3 days ago</span></h1>
					...
					<section class="docs-section" id="item-1-2">
						...
						<div class="simplelightbox-gallery row mb-3">
							<div class="col-12 col-md-4 mb-3">
						        <a href="{{ asset('documentation/images/coderpro-home.png') }}"><img class="figure-img img-fluid shadow rounded" src="{{ asset('documentation/images/coderpro-home-thumb.png') }}" alt="" title="CoderPro Home Page"/></a>
							</div>
							<div class="col-12 col-md-4 mb-3">
						        <a href="{{ asset('documentation/images/coderpro-features.png') }}"><img class="figure-img img-fluid shadow rounded" src="{{ asset('documentation/images/coderpro-features-thumb.png') }}" alt="" title="CoderPro Features Page"/></a>
							</div><!--//col-->
							<div class="col-12 col-md-4 mb-3">
						        <a href="{{ asset('documentation/images/coderpro-pricing.png') }}"><img class="figure-img img-fluid shadow rounded" src="{{ asset('documentation/images/coderpro-pricing-thumb.png') }}" alt="" title="CoderPro Pricing Page"/></a>
							</div><!--//col-->
